...
export MAIN_PLATFORMS='declare -A main_platforms=([opencm904]="OpenCM904:OpenCM904:OpenCM904")'
...
echo -n "ADD OpenCM904 PACKAGE INDEX: "
...
DEPENDENCY_OUTPUT=$(mv $PWD/OpenCM9.04/arduino/opencm_arduino/opencm9.04_release $HOME/Arduino/hardware/OpenCM904/OpenCM904 2>&1)
if [ $? -ne 0 ]; then echo -e "\xe2\x9c\x96"; else echo -e "\xe2\x9c\x93"; fi
