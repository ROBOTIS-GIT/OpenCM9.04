...
void setup() {
  ...
  unsigned int a = 0;
  while(1){
    if((int32_t)Dxl.readDword(1, PRESENT_POSITION) > -10000 && (int32_t)Dxl.readDword(1, PRESENT_POSITION) < 10000)
     break;
  }
  toggleLED();
  ...
  if(digitalRead(BUTTON1_485EXP) == 1){
    ...
    if(digitalRead(BUTTON1_485EXP) == 1){
      ...
      while(1){
        ...
        delay(100);
        while(abs((int32_t)Dxl.readDword(1, PRESENT_POSITION) - 62750) < 30 ){
