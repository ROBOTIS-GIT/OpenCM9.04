/* Dynamixel Maximum Torque Example

 This example shows how to use dynamixel as maximum torque
 All dynamixels are set as joint mode in factory,
 but if you want to make a wheel using dynamixel,
 you have to change it to maximum torque
...
void setup() {
  ...
  Dxl.maxTorque(ID_NUM,80); // it has maxtorque for weak movement
